...
public class IndexController {
	...
	public String index() {
		...
		// 뷰리졸버 설정: tempates (prefix), .mustache (suffix) 생략가능
	...
	// 스프링시큐리티가 해당주소를 낚아채감 - SecurityConfig 파일 생성 후 작동 안 함
	...
	public String join(User user) {
		...
		userReposiroty.save(user); //회원가입 잘 되지만 비밀번호: 1234 -> 시큐리티로 로그인을 할 수 없음. -> 패스워드 암호화 안 되었기 때문.
